...
public class ValidateUtil { 
	...
	public static boolean onlyOneIsNullOrEmpty(String value1, String value2) {
		int i = 0;
		if (value1 == null || "".equals(value1) || "".equals(value1.trim())) i++;
		if (value2 == null || "".equals(value2) || "".equals(value2.trim())) i++;
		if (i == 1) return true;
		return false;
	}
	...
	/** 两个不可为空的字符串是否相等*/
	public static boolean isNotNullableStringEqual(String pass1,String pass2) throws BaseAppException{ 
		// 如果只有字符串都为NULL，返回false
		if (ValidateUtil.isBlank(pass1) || ValidateUtil.isBlank(pass2))
			throw new BaseAppException("One or more string is nullb");
		// 判断两个字符串的内容是否相等
		if (pass1.equals(pass2))
			return true;		
		return false;				
	...
	public static boolean isArrayContains(String[] arrays,String s){
		try {
			if(arrays == null || ValidateUtil.isBlank(s)) return false; 
