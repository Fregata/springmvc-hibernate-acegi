...
public class IDCardUtil {
	private static Logger log = Logger.getLogger(IDCardUtil.class.getName());
	...
	public static boolean isIDCard(String IDStr) throws ParseException {
     ...
     if(IDStr.length()==18)     {   
     	...
     	log.debug("所在地区:"+h.get(Ai.substring(0,2).toString()));
     	log.debug("新身份证号:"+Ai);
     	return true;
     }
     //=====================(end)=====================
	...
	public static boolean isDate(String strDate)	{
	 Pattern pattern = Pattern.compile("((((19|20)(([13579][26])|([02468][048])))-((((0?[13578])|(1[02]))-((0?[1-9])|([12][0-9])|(3[01])))|(((0?[469])|11)-((0?[1-9])|([12][0-9])|30))|(0?2-((0?[1-9])|([12][0-9])))))|(((19|20)(([02468][1235679])|([13579][01345789])))-((((0?[13578])|(1[02]))-((0?[1-9])|([12][0-9])|(3[01])))|(((0?[469])|11)-((0?[1-9])|([12][0-9])|30))|(0?2-((0?[1-9])|(1[0-9])|(2[0-8]))))))");
