...
public class StringUtil {
	...
	public static final String convertDBC2SBC(String dbcStr){
		if(ValidateUtil.isNullOrEmpty(dbcStr)) return null;
	...
	public static String getBriefString(Object obj,String fieldName){ 
		try {
			String fieldValue = (String)PropertyUtils.getProperty(obj, fieldName); 
			if(fieldValue == null || fieldValue.trim().equals("") || fieldValue.length() < 14)
				return fieldValue;
     ...
     * @return
     */
    public static List getListBySepStr(String theString,String delim){
		try {
