        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			...
			<div id="sch-step1" class="panel panel-success">
		      ...
		      <div class="row row-offcanvas row-offcanvas-center" style="height:350px">
		     	<form id="step1-form" class="form-horizontal" role="form" method="post" action="">
			...
			<div id="sch-step2" class="panel panel-success" style="display:none">
			  <div class="panel-heading">
			  		<ol style="list-style:none;display:block;width:auto;margin:0px auto">
			          ...
			          <table class="table">
			            ...
			            <tbody>
			              <!-- c:forEach items="${appList}" var="item"-->
			               <tr>
			                 <td style="padding:4px 0px 0px 4px">0000101</td>
			                 <td style="padding:4px 0px 0px 4px">初中一年级</td>
			                 <td style="padding:0px">
				                 <div class="btn-group btn-group-sm" role="group" aria-label="Small button group">
							      <button type="button" class="btn btn-danger" data-toggle="collapse" data-target="#grdid">修改</button>
			               ...
			               <tr>
			               	<td colspan="3">
			               	<div id="grdid" class="bs-callout bs-callout-danger collapse">
			               		<div class="col-sm-8 col-sm-offset-2">
					                ...
					                <form class="form-horizontal" action="" method="POST">
										<div class="control-group">
								          ...
								          <div class="controls">
								            ...
								            <input id="grdCode" name="appCode" type="text" placeholder="0000101" class="input-xlarge" value="" disabled="disabled">
								          </div>
								        </div>
									    <div class="control-group">
								          <label class="control-label" for="appName">年级名称</label>
								          <div class="controls">
								            <input id="grdName" name="grdName" type="text" placeholder="" class="input-xlarge" value="">
								          </div>
								        </div>
			  ...
			  <form class="form-horizontal">
				  <div class="form-group" style="margin-bottom:0px">
	                   <div class="col-sm-6 col-sm-offset-5">
                           <div class="btn-group" role="group" aria-label="...">
			              	  <button type="button" class="btn btn-danger" onclick="previous('step2')">上一步</button>
			...
			<div id="sch-step3" class="panel panel-success" style="display:none">
			  <div class="panel-heading">
			  	<ol style="list-style:none;display:block;width:auto;margin:0px auto">
					<li style="padding-left:120px;display:inline">1.学校信息设置</li>
					<li style="padding-left:120px;display:inline">2.年级信息设置</li>
			 		<li style="padding-left:120px;display:inline"><font color="red"><strong>3.班级信息设置</strong></font></li>
				  </ol>
			  </div>
			  <div class="panel-body">
		      <div class="row row-offcanvas row-offcanvas-center" style="height:350px">
		     	<div class="table-responsive">
		          <table class="table">
		            ...
		            <tbody>
		              <!-- c:forEach items="${appList}" var="item"-->
		               <tr>
		                 <td style="padding:4px 0px 0px 4px">000010101</td>
		                 <td style="padding:4px 0px 0px 4px">初中一年级(1)班</td>
		                 <td style="padding:0px">
			                 <div class="btn-group btn-group-sm" role="group" aria-label="Small button group">
						      <button type="button" class="btn btn-danger" data-toggle="collapse" data-target="#clzid">修改</button>
						      <button type="button" class="btn btn-danger" onclick="deleteGrd()">删除</button>
						     </div>
		                 </td>
		               </tr>
		               <tr>
		               	<td colspan="3">
		               		<div id="clzid" class="bs-callout bs-callout-danger collapse">
			               		<div class="col-sm-8 col-sm-offset-2">
			               		<div class="panel panel-default well" >
					                <div class="panel-heading">
					                ...
					                <form class="form-horizontal" action="" method="POST">
										<div class="control-group">
								          ...
								          <div class="controls">
								          	<input name="grdId" type="text" value="item.appid" style="display:none">
								            <input id="grdCode" name="appCode" type="text" placeholder="000010101" class="input-xlarge" value="" disabled="disabled">
								          </div>
								        </div>
									    <div class="control-group">
			  ...
			  <form class="form-horizontal">
				  <div class="form-group" style="margin-bottom:0px">
	                   <div class="col-sm-6 col-sm-offset-5">
                           <div class="btn-group" role="group" aria-label="...">
			              	  <button type="button" class="btn btn-danger" onclick="previous('step3')">上一步</button>
			              	  <button type="button" class="btn btn-success" onclick="next('step3')">完成</button>
						   </div>
                       </div>
	               </div>
			  </form>
