		      ...
		      <div class="row row-offcanvas row-offcanvas-center" style="height:350px">
		     	<form class="form-horizontal" role="form">
			        ...
			        <div class="control-group" class="col-sm-4 col-sm-offset-2">
			          <label class="control-label" for="input01">学生信息模板下载</label>
			          <div class="controls">
                 ...
                 <form id="student-step2-form" class="form-horizontal" enctype="multipart/form-data" method="post" action="${ctx}/super/student/step2.html">
                    <div class="col-sm-6">
			        <div class="control-group" class="col-sm-6">
			          <label class="control-label" for="input01">学生信息数据上传</label>
			          <div class="controls">
			            <input name="studentData" type="file" accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet">
			          </div>
			        </div>
			        </div>
                 </form>
				  ...
				  <div class="form-group" style="margin-bottom:0px">
	                   <div class="col-sm-6 col-sm-offset-5">
                           <div class="btn-group" role="group" aria-label="...">
			              	  <button type="button" class="btn btn-success" onclick="next('student-step2-form')">下一步</button>
						   </div>
                       </div>
	               </div>
			  </form>
   ...
   <!-- Bootstrap core JavaScript
    ...
    <script>
		...
		school.onchange = function() {
			var url = "${ctx}/super/student/"+school.value;
			window.open(url);
		};
	</script>
  </body>
